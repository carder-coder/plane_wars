...
export class Migration {
   ...
   * 创建房间表
   */
  private static async createRoomsTable(): Promise<void> {
    const sql = `
   ...
   * 创建房间成员表
   */
  private static async createRoomMembersTable(): Promise<void> {
    const sql = `
   ...
   * 创建游戏记录表
   */
  private static async createGamesTable(): Promise<void> {
    const sql = `
